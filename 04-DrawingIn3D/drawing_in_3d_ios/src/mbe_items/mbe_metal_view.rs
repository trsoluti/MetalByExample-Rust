...
use objc::runtime::{Object, Sel, Class, object_getClass, NO};
...
use cocoa::foundation::{NSInteger, NSTimeInterval, NSUInteger};
...
impl RustMetalView {
    ...
    pub fn register() {
        ...
        unsafe {
            ...
            class_decl.add_method(
                sel!(setFrame:),
                set_frame as extern "C" fn(&mut Object, Sel, EncodableCGRect),
            );
            class_decl.add_method(
                sel!(didMoveToWindow),
...
// {
extern "C" fn set_frame(_self: &mut Object, _sel: Sel, frame: EncodableCGRect) {
...
// {
extern "C" fn did_move_to_window(_self: &mut Object, _sel: Sel) {
    ...
    // {
        ...
        let mut rust_metal_view = get_mut_rust_metal_view(_self).unwrap();
        rust_metal_view.display_link.invalidate();
        rust_metal_view.display_link = CoreAnimDisplayLink::default();
    }
    // }
}
// }
